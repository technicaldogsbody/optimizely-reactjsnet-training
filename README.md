...
* From the src folder
    * <code>dotnet-episerver create-cms-database Training.A.csproj -S localhost -U sa -P epiR0cks</code>
    * <code>dotnet-episerver add-admin-user Training.A.csproj -u dept -p P4ssw0rd! -e user@email.com -c EPiServerDB</code>
